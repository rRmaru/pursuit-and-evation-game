...
def parse_args():
    ...
    parser.add_argument("--save-dir", type=str, default="./tmp/alpha0_1/", help="directory in which training state and model should be saved")
    ...
    return parser.parse_args(["--num-episodes", "20000", "--adv-policy", "maddpg", "--exp-name", "alpha0_1"])
    ...
    with U.single_threaded_session():
        ...
        while True:
            ...
            if len(episode_rewards) > arglist.num_episodes:
                ...
                with open('rewards_alpha0_1.txt', 'w') as f:
