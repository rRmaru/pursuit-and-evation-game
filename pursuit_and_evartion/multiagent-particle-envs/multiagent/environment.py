...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        self.discrete_action_space = True       #出力は離散値？
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                u_action_space = spaces.Discrete(world.dim_p * 2 + 1)       #wirkd.dim_p is 2 therfor 2*2+1=5
            else:
            ...
            #pdb.set_trace()
            self.observation_space.append(spaces.Box(low=-np.inf, high=+np.inf, shape=(obs_dim,), dtype=np.float32))   #16の連続値 Box[16,]
    ...
    def reset(self):
        # reset world
        self.reset_callback(self.world)  #scenarioのreset_worldを持ってきている
        # reset renderer
        self._reset_render()
